...
public class ServiceController {
    ...
    public void tableCreation() {
        ...
        tableService.setCellValueFactory(new PropertyValueFactory<>("Name"));
        tableService.setCellFactory(TextFieldTableCell.forTableColumn());
        getGuests();
        tableGuest.setCellValueFactory(m -> new SimpleObjectProperty<>(m.getValue().getGuests().get(0)));
